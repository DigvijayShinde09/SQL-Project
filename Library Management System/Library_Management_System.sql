...
SELECT * FROM tbl_library_branch;
	...
	borrower_CardNo INT PRIMARY KEY NOT NULL IDENTITY (1,100),
...
SET library_branch_BranchName = 'Central' WHERE library_branch_BranchID = 2;*/
...
SELECT "book_copies_BranchID" AS Branch_ID, 
	"library_branch_BranchName" AS Branch_Name,
	"book_copies_No_Of_Copies" AS Number_of_Copies,
...
SELECT "library_branch_BranchName" AS Branch_Name, "book_Title" AS Book_Name,
	"borrower_BorrowerName" AS Borrower_Name, "borrower_BorrowerAddress" AS Borrower_Address, "book_loans_DueDate" AS Due_Date
...
SELECT  "library_branch_BranchName" AS Branch_Name, COUNT ("book_loans_BranchID") AS Total_Loans
	FROM tbl_book_loans AS Loans
	INNER JOIN tbl_library_branch AS Branch ON "book_loans_BranchID" = "library_branch_BranchID"
...
SELECT "borrower_BorrowerName" AS Borrower_Name, "borrower_BorrowerAddress" AS Borrower_Address,
	COUNT("borrower_BorrowerName") AS Books_Checked_Out
	FROM tbl_book_loans AS Loans
	INNER JOIN tbl_borrower AS Borrower ON "book_loans_CardNo" = "borrower_CardNo"
...
SELECT "library_branch_BranchName" AS Branch_Name,"book_authors_AuthorName" AS Author_Name,  "book_Title" AS Title, "book_copies_No_Of_Copies" AS Number_of_Copies
	FROM tbl_book_authors AS Authors
	INNER JOIN tbl_book AS Book ON "book_authors_BookID" = "book_BookID"
	INNER JOIN tbl_book_copies AS Copies ON "book_authors_BookID" = "book_copies_BookID"
